...
application: lookereiprint {
  ...
  entitlements: {
    ...
    external_api_urls : ["https://83d14716-08b3-4def-bdca-54f4b2af9f19-extensions.cloud.looker.com","https://looker-ext-code-17837811141.us-central1.run.app","http://localhost:8080","https://localhost:8080","http://localhost:8001","https://localhost:8001","https://kb-bean-caroline-barn.trycloudflare.com","https://cdn.tiny.cloud"] # Ensure this is your current ngrok URL if it's dynamic
