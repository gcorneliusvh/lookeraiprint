...
application: lookereiprint {
  ...
  entitlements: {
    ...
    external_api_urls: ["https://885d-2001-569-5925-3000-216-3eff-fe9a-a055.ngrok-free.app","http://localhost:8080","http://localhost:8001"] # Ensure this is your current ngrok URL if it's dynamic
